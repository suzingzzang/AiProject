...
### **보행 보조 모드[AI Modeling] - 노면 상태 확인 및 특이 사항 발생 경우**
...
1-2. 점자블록이 깨진 경우, 더이상 이어지지 않은 경우

> '파손 점자블록이 발견되었습니다. 조심하세요. 이미지를 저장합니다.'

> 민원 신청을 위해 자동으로 캡처 및 위치 정보 저장

1-3. 장애물 발생: '전방에 ㅇㅇㅇ가 있습니다. 주의하세요' (※ 오감지를 방지하기 위한 범위 조정 필요)

### **보행 보조 모드[AI Modeling] - 보행 중, 낙상 사고 발생 경우**
